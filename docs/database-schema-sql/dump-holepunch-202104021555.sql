...
-- Started on 2021-04-02 15:55:55
...
-- Name: service_allow_rule; Type: TABLE; Schema: holepunch; Owner: postgres
--

CREATE TABLE holepunch.service_allow_rule (
    id integer NOT NULL,
...
ALTER TABLE holepunch.service_allow_rule OWNER TO postgres;

--
-- TOC entry 3013 (class 0 OID 0)
-- Dependencies: 206
-- Name: TABLE service_allow_rule; Type: COMMENT; Schema: holepunch; Owner: postgres
--

COMMENT ON TABLE holepunch.service_allow_rule IS '容許網段';


--
-- TOC entry 3014 (class 0 OID 0)
-- Dependencies: 206
-- Name: COLUMN service_allow_rule.service_id; Type: COMMENT; Schema: holepunch; Owner: postgres
--

COMMENT ON COLUMN holepunch.service_allow_rule.service_id IS '服務ID';


--
-- TOC entry 3015 (class 0 OID 0)
-- Dependencies: 206
-- Name: COLUMN service_allow_rule.service_forward_target_id; Type: COMMENT; Schema: holepunch; Owner: postgres
--

COMMENT ON COLUMN holepunch.service_allow_rule.service_forward_target_id IS '服務轉發目標ID，若為空則表示整個服務';


--
-- TOC entry 3016 (class 0 OID 0)
-- Dependencies: 206
-- Name: COLUMN service_allow_rule.type; Type: COMMENT; Schema: holepunch; Owner: postgres
--

COMMENT ON COLUMN holepunch.service_allow_rule.type IS '類型(CIDR_GROUP、CIDR、USER_GROUP、USER)';


--
-- TOC entry 3017 (class 0 OID 0)
-- Dependencies: 206
-- Name: COLUMN service_allow_rule.cidr_group_id; Type: COMMENT; Schema: holepunch; Owner: postgres
--

COMMENT ON COLUMN holepunch.service_allow_rule.cidr_group_id IS '網段組';


--
-- TOC entry 3018 (class 0 OID 0)
-- Dependencies: 206
-- Name: COLUMN service_allow_rule.cidr; Type: COMMENT; Schema: holepunch; Owner: postgres
--

COMMENT ON COLUMN holepunch.service_allow_rule.cidr IS '網段';


--
-- TOC entry 3019 (class 0 OID 0)
-- Dependencies: 206
-- Name: COLUMN service_allow_rule.user_group_id; Type: COMMENT; Schema: holepunch; Owner: postgres
--

COMMENT ON COLUMN holepunch.service_allow_rule.user_group_id IS '使用者群組';


--
-- TOC entry 3020 (class 0 OID 0)
-- Dependencies: 206
-- Name: COLUMN service_allow_rule.user_id; Type: COMMENT; Schema: holepunch; Owner: postgres
--

COMMENT ON COLUMN holepunch.service_allow_rule.user_id IS '使用者ID';
...
ALTER TABLE holepunch.service_allow_rule ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
INSERT INTO holepunch.cidr_group OVERRIDING SYSTEM VALUE VALUES (3, 'Any_IPv4', '{0.0.0.0/0}');
INSERT INTO holepunch.cidr_group OVERRIDING SYSTEM VALUE VALUES (4, 'Any_IPv6', '{::/0}');
...
INSERT INTO holepunch."user" OVERRIDING SYSTEM VALUE VALUES (1, 'admin', '8291b62e06da5867634ffdee4de277a9342524e3', 'Administrator', true);
...
SELECT pg_catalog.setval('holepunch.cidr_group_id_seq', 4, true);
...
SELECT pg_catalog.setval('holepunch.service_allowlist_id_seq', 14, true);
...
SELECT pg_catalog.setval('holepunch.service_forward_target_id_seq', 3, true);
...
SELECT pg_catalog.setval('holepunch.service_id_seq', 7, true);
...
SELECT pg_catalog.setval('holepunch.user_group_id_seq', 2, true);
...
SELECT pg_catalog.setval('holepunch.user_id_seq', 10, true);
...
-- Name: service_allow_rule pk_service_allow_cidr_id; Type: CONSTRAINT; Schema: holepunch; Owner: postgres
--

ALTER TABLE ONLY holepunch.service_allow_rule
...
-- Completed on 2021-04-02 15:56:02
